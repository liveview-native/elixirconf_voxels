defmodule ElixirconfVoxelsNative do
  @moduledoc """
  ...
  import ElixirconfVoxelsWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {ElixirconfVoxelsWeb.Layouts.SwiftUI, :app}
        ]
  ...
  def layout(opts) do
    ...
    quote do
      ...
      import ElixirconfVoxelsWeb.CoreComponents.SwiftUI
