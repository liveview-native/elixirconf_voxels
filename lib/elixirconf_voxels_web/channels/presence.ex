defmodule ElixirconfVoxelsWeb.Presence do
  @moduledoc """
  ...
  def handle_metas(topic, %{joins: joins, leaves: leaves}, presences, state) do
    for {user_id, presence} <- joins do
      ...
      Phoenix.PubSub.local_broadcast(ElixirconfVoxels.PubSub, "proxy:#{topic}", msg)
    end
  ...
  def subscribe(), do: Phoenix.PubSub.subscribe(ElixirconfVoxels.PubSub, "proxy:online_users")
end
